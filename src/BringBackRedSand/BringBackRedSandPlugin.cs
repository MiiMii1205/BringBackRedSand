...
public partial class BringBackRedSandPlugin : BaseUnityPlugin
{
    ...
    private static readonly Color BloodRedTopColor = new(0.592f, 0.102f, 0f, 1f);
    private static readonly Color BloodRedTop2Color = new(0.1137255f, 0.007843135f, 0.007843135f, 0.8156863f);
    ...
    internal static Material RedRockMaterial
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    internal static Material RedFoliageMaterial
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static void UpdateMaterialColors()
    {
